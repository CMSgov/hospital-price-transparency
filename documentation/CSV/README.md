...
| Column Header (Tall format) | Column Header (Wide format) | Name | Type | Definition | Blanks Accepted |
| ----- | ---- | ---- |  ---- | ---------- | -------- |
